...
- Update fasterxml dependency version [\#452](https://github.com/k3po/k3po/pull/452) ([jfallows](https://github.com/jfallows))
- Fixes to allow integer and long properties to be read and written using correct byte order [\#451](https://github.com/k3po/k3po/pull/451) ([cmebarrow](https://github.com/cmebarrow))

## [3.0.0-alpha-82](https://github.com/k3po/k3po/tree/3.0.0-alpha-82) (2017-10-04)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-81...3.0.0-alpha-82)

**Merged pull requests:**

- Use ChannelBufferFactory to encode messages [\#450](https://github.com/k3po/k3po/pull/450) ([jfallows](https://github.com/jfallows))

## [3.0.0-alpha-81](https://github.com/k3po/k3po/tree/3.0.0-alpha-81) (2017-10-03)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-80...3.0.0-alpha-81)

**Merged pull requests:**

- Support hex literal longs and integers [\#449](https://github.com/k3po/k3po/pull/449) ([jfallows](https://github.com/jfallows))

## [3.0.0-alpha-80](https://github.com/k3po/k3po/tree/3.0.0-alpha-80) (2017-08-18)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-79...3.0.0-alpha-80)

**Merged pull requests:**

- Add spec to close connection after receiving a HTTP request with head… [\#448](https://github.com/k3po/k3po/pull/448) ([Anisotrop](https://github.com/Anisotrop))
- Add payload to connection.close test. [\#447](https://github.com/k3po/k3po/pull/447) ([Anisotrop](https://github.com/Anisotrop))

## [3.0.0-alpha-79](https://github.com/k3po/k3po/tree/3.0.0-alpha-79) (2017-07-19)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-78...3.0.0-alpha-79)

**Merged pull requests:**

- Log ABORT at DEBUG level to eliminate noise on stdout… [\#446](https://github.com/k3po/k3po/pull/446) ([jfallows](https://github.com/jfallows))

## [3.0.0-alpha-78](https://github.com/k3po/k3po/tree/3.0.0-alpha-78) (2017-07-19)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-77...3.0.0-alpha-78)

**Merged pull requests:**

- Support incremental decode of configuration [\#445](https://github.com/k3po/k3po/pull/445) ([jfallows](https://github.com/jfallows))

## [3.0.0-alpha-77](https://github.com/k3po/k3po/tree/3.0.0-alpha-77) (2017-07-09)
[Full Changelog](https://github.com/k3po/k3po/compare/3.0.0-alpha-76...3.0.0-alpha-77)
