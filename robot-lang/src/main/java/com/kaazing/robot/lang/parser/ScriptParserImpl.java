...
public class ScriptParserImpl implements ScriptParser {
    ...
    public ScriptParserImpl(String format) {
        ...
        switch (formatVersion) {
            case 1:
                parser = new com.kaazing.robot.lang.parser.v1.ScriptParserImpl();
                break;
            case 2:
                parser = new com.kaazing.robot.lang.parser.v2.ScriptParserImpl();
                break;
        }
    }
    ...
    public ScriptParserImpl(String format, ExpressionFactory factory, ExpressionContext context) {
        ...
        switch (formatVersion) {
            case 1:
                parser = new com.kaazing.robot.lang.parser.v1.ScriptParserImpl(factory, context);
                break;
            case 2:
                parser = new com.kaazing.robot.lang.parser.v2.ScriptParserImpl(factory, context);
                break;
        }
    }
