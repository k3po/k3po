 ...
 * under the License.
 */
package org.kaazing.specification.http.rfc2616;
 ...
 */
public class HttpProxyStatusCodeIT {

    private final K3poRule k3po = new K3poRule().setScriptRoot("org/kaazing/specification/http/rfc2616/status.code");
