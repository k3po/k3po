/*
 * Copyright 2016, Kaazing Corporation. All rights reserved.
 *
 ...
 */
public class IdIT {
    private final K3poRule k3po = new K3poRule().setScriptRoot("org/kaazing/specification/sse/id");
    ...
    @Specification({
        "no.value/request",
        "no.value/response" })
    public void shouldReceiveMessageWithEmptyId() throws Exception {
        k3po.finish();
    }
