...
public class AllocationsIT {
     ...
     */
    @Test
    @Specification({"incorrect.allocation.with.wrong.transaction.id/request", "incorrect.allocation.with.wrong.transaction.id/response" })
    public void shouldFailWithIncorrectTransactionId() throws Exception {
        k3po.finish();
    }
     ...
     */
    @Test
    @Specification({"invalid.requested.transport.attribute.responds.400/request",
            "invalid.requested.transport.attribute.responds.400/response"})
    public void shouldRespond400ToAllocateWithInvalidTransportAttribute() throws Exception {
        k3po.finish();
    }
