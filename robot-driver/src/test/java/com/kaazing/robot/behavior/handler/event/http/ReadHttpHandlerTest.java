...
import com.kaazing.robot.behavior.handler.TestChannelEvent;
...
public class ReadHttpHandlerTest {
    ...
    private HttpMessageContributingDecoder decoder;
        ...
        context.checking(new Expectations() {
            {
                ...
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(ChildChannelStateEvent.class)));
            }
        });
        ...
        context.checking(new Expectations() {
            {
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(PreparationEvent.class)));
                oneOf(upstream)
                        .handleUpstream(with(any(ChannelHandlerContext.class)), with(channelState(INTEREST_OPS)));
            }
        });
        ...
        context.checking(new Expectations() {
            {
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(PreparationEvent.class)));
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(WriteCompletionEvent.class)));
            }
        });
        ...
        context.checking(new Expectations() {
            {
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(PreparationEvent.class)));
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)),
                        with(any(TestChannelEvent.class)));
            }
        });
    ...
    @Test
    public void shouldPropogateUpstreamHttpEventThatMatches() throws Exception {
        ...
        context.checking(new Expectations() {
            {
                ...
                oneOf(upstream).handleUpstream(with(any(ChannelHandlerContext.class)), with(message(message)));
            }
        });
