...
package org.kaazing.k3po.pcap.converter.tcpconverter.parser;
...
import org.kaazing.k3po.pcap.converter.tcpconverter.packet.Packet.RequestType;
...
public class Parser {
    ...
    private Packet setHttpFieldProperties(XmlStartTag st, Packet currentPacket) throws XmlPullParserException {
        ...
        if ( attributes.checkIfEqual("name", "http.request.method") ) {
            currentPacket.setHttpRequestType(RequestType.valueOf(attributes.get("show")));
        }
