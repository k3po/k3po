...
public class BaseFramingIT {
    ...
    private final RobotRule robot = new RobotRule().setScriptRoot("org/kaazing/specification/ws/framing");
    ...
    @Test
    @Robotic({"echo.binary.payload.length.0/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.125/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.126/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.127/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.128/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.65535/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.binary.payload.length.65536/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.0/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.125/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.126/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.127/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.128/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.65535/handshake.request.and.frame",
    ...
    @Test
    @Robotic({"echo.text.payload.length.65536/handshake.request.and.frame",
