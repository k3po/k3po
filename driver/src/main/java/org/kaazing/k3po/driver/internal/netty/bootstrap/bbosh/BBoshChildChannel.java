...
public final class BBoshChildChannel extends AbstractChannel<BBoshChannelConfig> {

    BBoshChildChannel(ServerChannel parent, ChannelFactory factory, ChannelPipeline pipeline, ChannelSink sink) {
        super(parent, factory, pipeline, sink, new DefaultBBoshChannelConfig());
    }
