...
public class WriteHttpStatusHandler extends AbstractCommandHandler {

    private final MessageEncoder codeEncoder;
    private final MessageEncoder reasonEncoder;

    public WriteHttpStatusHandler(MessageEncoder codeEncoder, MessageEncoder reasonEncoder) {
