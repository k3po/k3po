...
public abstract class AstValue<T> extends AstRegion {
    ...
    public interface Visitor<R, P> {
        ...
        R visit(AstLiteralIntegerValue value, P parameter) throws Exception;

        R visit(AstLiteralLongValue value, P parameter) throws Exception;

        R visit(AstLiteralURIValue value, P parameter) throws Exception;
    }
